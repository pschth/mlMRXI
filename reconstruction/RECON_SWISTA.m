        ...
        function o = reconstruct(o)
            ...
            if o.req.deltaMin == 0
                ...
                while o.int.i < o.req.nIter && o.req.deltaMin < o.int.dev
                    ...
                    o.int.preresult(o.int.keepIdx) = o.int.result(o.int.keepIdx);
                    o.int.prethresh(o.int.keepIdx) = o.int.result(o.int.keepIdx) - ...
                        2*o.req.alpha *(o.int.LtL(o.int.keepIdx, o.int.keepIdx)*o.int.result(o.int.keepIdx) - ...
                        o.int.Ltb(o.int.keepIdx));
                    o.int.result(o.int.keepIdx) = o.int.prethresh(o.int.keepIdx) - ...
                        sign(o.int.prethresh(o.int.keepIdx)).*o.int.scalc(o.int.keepIdx)*o.req.alpha*o.req.lambda;
                    o.int.STresult = o.int.result(o.int.keepIdx);
                    o.int.STresult( sign(o.int.STresult) ~= sign(o.int.prethresh(o.int.keepIdx)) ) = 0;
