classdef RECON_ELASTIC_NET_CUSTOM < handle
    ...
    methods (Access = public)
        function o = RECON_ELASTIC_NET_CUSTOM(L,b)
            % constructor
            %
            % INPUT:
            ...
            o.info.name       = 'ELASTIC_NET_CUSTOM';
    ...
    methods (Access = private)
        ...
        function o = init(o)
            ...
            o.req.alpha                 = [];                                    % Lipschitz constant
            o.req.Gamma                 = ones( o.int.nVox, 1);                 % Tikhonov weighting vector
            o.req.lambda_1              = 1e-5;                                 % l1 regularization parameter
            o.req.lambda_2              = 1e-5;                                 % l2 regularization parameter
        ...
        function o = initInternals(o)
            ...
            % calculate voxel weighting
            o.int.s = ones(o.int.nVox, 1);
        ...
        function o = initInfo(o)
            ...
            %%% field names)
            o.info.alpha = 'Scalar - Lipschitz constant';
            o.info.lambda_1 = 'Scalar - L1 regularization parameter';
            o.info.lambda_2 = 'Scalar - L2 regularization parameter';
        ...
        function o = reconstruct(o)
            ...
            if o.int.i == 0
                ...
                o.int.preresult = zeros(size(o.int.result));
                o.int.prethresh = zeros(size(o.int.result));

                % initialize calculation constants
                o.int.LtL = o.int.L'*o.int.L;
                o.int.Gamma2 = o.req.Gamma'*o.req.Gamma;
                o.int.invLtLw = inv(o.int.LtL + o.req.lambda_2*o.int.Gamma2);
                o.int.Ltb = o.int.L'*o.int.b;
                o.int.Const1 = o.int.invLtLw*o.int.Ltb;
                o.int.Const2 = eye(o.int.nVox) - o.int.invLtLw*o.int.LtL;
                
                
                % initialize step size if not given
                if isempty(o.req.alpha)
                    o.req.alpha = 0.999/normest(o.int.L'*o.int.L);
                end

                % initialize sensitivity weighting
                o.int.scalc = o.int.s;
            ...
            if o.req.deltaMin == 0
                ...
                while o.int.i < o.req.nIter && o.req.deltaMin < o.int.dev
                    ...
                    o.int.result(o.int.keepIdx) = wthresh(o.int.result(o.int.keepIdx) - ...
                        o.int.Gamma2*2*o.req.alpha *(o.int.LtL(o.int.keepIdx, o.int.keepIdx)*o.int.result(o.int.keepIdx) - ...
                        o.int.Ltb(o.int.keepIdx)), 's', o.req.alpha*o.req.lambda_1);
% 
%                     % perform FISTA step
%                     o.int.t1 = o.int.i + 1;
%                     o.int.t2 = (1 + sqrt(1 + 4*o.int.t1^2)) / 2;
%                     o.int.result = o.int.result + ((o.int.t1-1) / o.int.t2) * (o.int.result - o.int.preresult);
                    ...
                    if o.int.ZER
                        % get all zero entries
                        o.int.zero(o.int.keepIdx) = o.int.result(o.int.keepIdx) == 0;
                        % reset all nonzero entries in the counter
                        o.int.ZERcounter(~o.int.zero) = 0;
                        % increment all zero entries in the counter
                        o.int.ZERcounter(o.int.keepIdx) = o.int.ZERcounter(o.int.keepIdx) + o.int.zero(o.int.keepIdx);
                        % mark zero entries if threshold is hit
                        o.int.removeZE(o.int.keepIdx) = o.int.removeZE(o.int.keepIdx) | ...
                            o.int.ZERcounter(o.int.keepIdx) == o.aux.neglectZeroEntryLimit;
                    end
                ...
                while o.int.i < o.req.nIter && o.req.deltaMin < o.int.dev
                    ...
                    % perform soft thresholding
                    o.int.result(o.int.keepIdx) = wthresh(o.int.result(o.int.keepIdx) - ...
                        2*o.req.alpha *(o.int.LtL(o.int.keepIdx, o.int.keepIdx)*o.int.result(o.int.keepIdx) - ...
                        o.int.Ltb(o.int.keepIdx)), 's', o.req.alpha*o.req.lambda_1);
