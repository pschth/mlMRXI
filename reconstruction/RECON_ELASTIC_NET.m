classdef RECON_ELASTIC_NET < handle
    ...
    methods (Access = public)
        function o = RECON_ELASTIC_NET(L,b)
            % constructor
            %
            % INPUT:
    ...
    methods (Access = private)
        ...
        function o = reconstruct(o)
            ...
            if o.int.i == 0
                ...
                o.int.L_star = 1/sqrt(1+o.req.lambda_2) * ...
                        [o.int.L; sqrt(o.req.lambda_2) * eye(o.int.nVox)];
                o.int.b_star = [o.int.b; zeros(o.int.nVox,1)];
                o.int.gamma = o.req.lambda_1/sqrt(1 + o.req.lambda_2);
                o.aux.xInit = sqrt(1+o.req.lambda_2)*o.aux.xInit;
                
                o.int.LtL = o.int.L_star'*o.int.L_star;
                o.int.Ltb = o.int.L_star'*o.int.b_star;
                
                
                % initialize step size if not given
                if isempty(o.req.alpha)
                    o.req.alpha = 0.999/normest(o.int.L_star'*o.int.L_star);
                end
            ...
            if o.req.deltaMin == 0
                ...
                while o.int.i < o.req.nIter && o.req.deltaMin < o.int.dev
                    ...
                    o.int.result(o.int.keepIdx) = (1+o.req.lambda_2)*wthresh(o.int.result(o.int.keepIdx) - ...
                        2*o.req.alpha *(o.int.LtL(o.int.keepIdx, o.int.keepIdx)*o.int.result(o.int.keepIdx) - ...
                        o.int.Ltb(o.int.keepIdx)), 's', o.req.alpha*o.int.gamma);
