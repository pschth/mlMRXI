        ...
        function o = reconstruct(o)
            ...
            if o.req.deltaMin == 0
                ...
                while o.int.i < o.req.nIter && o.req.deltaMin < o.int.dev
                    ...
                    o.int.prethresh = o.int.result - 2*o.req.alpha *(o.int.LtL*o.int.result - o.int.Ltb);
                    o.int.result = o.int.prethresh - sign(o.int.prethresh).*o.int.scalc*o.req.alpha*o.req.lambda;
                    o.int.result( sign(o.int.result) ~= sign(o.int.prethresh) ) = 0;
