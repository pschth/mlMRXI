classdef RECON_ISTA < handle
    ...
    methods (Access = private)
        ...
        function o = init(o)
            ...
            o.req.alpha                 = 0.999/normest(o.int.L'*o.int.L);      % Lipschitz constant
            o.req.lambda                = 1e-5;                                 % l1 regularization parameter
            ...
            o.aux.verbose               = true;
            o.aux.gamma                 = ones(o.int.nVox, 1);
            o.aux.neglectZeroEntryLimit = Inf;                      % Defines the number of iterations after which elements which have been zero all the time are removed from the equation
        end
        ...
        function o = initInfo(o)
            ...
            o.info.lambda = 'Scalar - L1 regularization parameter';
...
%                 o.int.scalc = o.aux.gamma(:);
%                 o.int.scalc = o.int.scalc ./ norm(o.int.scalc);
                o.int.scalc = ones(size(o.int.result));
            ...
            if o.req.deltaMin == 0
                ...
                while o.int.i < o.req.nIter && o.req.deltaMin < o.int.dev
                    ...
                    o.int.result(o.int.keepIdx) = wthresh(o.int.result(o.int.keepIdx) - ...
                        ...
                        o.int.Ltb(o.int.keepIdx)), 's', o.req.alpha*o.req.lambda);
